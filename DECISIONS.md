...
- **NOT covered:** the wording, which is mine; the decision to record it as an ADR rather than only in `AI_GUIDELINES.md`, mine; and the prerequisite-checks change to the New Investigation template described below, which is mine and is attributed separately.
